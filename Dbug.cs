...
#region Special Loggers
        ...
        public static void Physics(string msg) => CustomLog($"🚀 {msg}", "#83cbff"); // OG being #FF0000
        public static void Test(string msg) => CustomLog($"🧪 {msg}", "#C3EF3C");
        public static void Info(string msg) => CustomLog($"📐 {msg}", "#FFFFFF");
        public static void Hit(string msg) => CustomLog($"💥 {msg}", "#fcd53f"); // OG being #FF0000

        #endregion
        #region Status Loggers

        public static void Started(string msg) => CustomLog($"🔋 {msg}", "#00d26a");
        public static void Stopped(string msg) => CustomLog($"🛑 {msg}", "#f8312f"); // OG being #FF0000
        public static void Succeeded(string msg) => CustomLog($"✅ {msg}", "#00d26a", underline : true);
        public static void Failed(string msg) => CustomLog($"❌ {msg}", "#f72f5e", strikethrough : true); // OG being #FF0000

        #endregion
        #region Emphasized - Misc Loggers

        public static void Emphasis(string msg)
        {
